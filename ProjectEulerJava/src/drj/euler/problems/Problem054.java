 ...
 * 
 * <p>High Card: Highest value card.
 * <br>One Pair: Two cards of the same value.
 * <br>Two Pairs: Two different pairs.
 * <br>Three of a Kind: Three cards of the same value.
 * <br>Straight: All cards are consecutive values.
 * <br>Flush: All cards of the same suit.
 * <br>Full House: Three of a kind and a pair.
 * <br>Four of a Kind: Four cards of the same value.
 * <br>Straight Flush: All cards are consecutive values of same suit.
 * <br>Royal Flush: Ten, Jack, Queen, King, Ace, in same suit.
 * <p>The cards are valued in the order:
 * <br>2, 3, 4, 5, 6, 7, 8, 9, 10, Jack, Queen, King, Ace.
 *
 * <p>If two players have the same ranked hands then the rank made up of the
 ...
 * and so on.
 *
 * <p>Consider the following five hands dealt to two players:
 *<pre>
 ...
 *          With Three Fours    with Three Threes</pre>
 *          
 * <p>The file, poker.txt, contains one-thousand random hands dealt to two
 ...
 * 
 * <p>How many hands does Player 1 win?
 */
@Answer("376")
