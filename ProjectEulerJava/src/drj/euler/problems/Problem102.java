 ...
 * 
 * <p>Consider the following two triangles:
 * 
 * <p>		A(-340,495), B(-153,-910), C(835,-947)
 * <br>		X(-175,41), Y(-421,-714), Z(574,-645)
 * 
 * <p>It can be verified that triangle ABC contains the origin, whereas
 * triangle XYZ does not.
 * 
 * <p>Using triangles.txt (right click and 'Save Link/Target As...'), a 27K
 * text file containing the co-ordinates of one thousand "random" triangles,
 * find the number of triangles for which the interior contains the origin.
 * 
 * <p>NOTE: The first two examples in the file represent the triangles in the
 * example given above.
 */
@Answer("228")
