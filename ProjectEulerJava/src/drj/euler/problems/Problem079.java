 ...
 * reply would be: 317.
 * 
 * <p>The text file, keylog.txt, contains fifty successful login attempts.
 * 
 * <p>Given that the three characters are always asked for in order, analyze
 * the file so as to determine the shortest possible secret password of unknown
 * length.
 */
@Answer("73162890")
