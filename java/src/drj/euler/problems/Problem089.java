 ...
 * 
 * <p>For example, the following represent all of the legitimate ways of
 ...
 * <br>		XVI
 * 
 * <p>The last example being considered the most efficient, as it uses the least
 * number of numerals.
 * 
 * <p>The 11K text file, roman.txt (right click and 'Save Link/Target As...'),
 ...
 * for this problem).
 * 
 * <p>Find the number of characters saved by writing each of these in their
 * minimal form.
 * 
 * <p>Note: You can assume that all the Roman numerals in the file contain no
