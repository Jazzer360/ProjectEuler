 ...
 * 
 * <p>		123, 124, 125, 134, 135, 145, 234, 235, 245, and 345
 * 
 * <p>In combinatorics, we use the notation, 5C3 = 10.
 * 
 * <p>In general,
 * 		nCr = n! / r!(n-r)!  ,where r <= n, n! = n(n-1)...3x2x1, and 0! = 1.
 * 
 * <p>It is not until n = 23, that a value exceeds one-million: 23C10 = 1144066.
 * 
 * <p>How many, not necessarily distinct, values of nCr, for 1 <= n <= 100, are
